          ...
          <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center justify-between">
            ...
            <div className="w-full lg:w-1/2 space-y-5 lg:pl-12 text-center lg:text-left">
              ...
              <p className="text-[#ffd166]">
                ...
                smart age-detection app, designed to be fun, fast, and
                incredibly easy to use. Whether you’re curious about how young
                you look, want to challenge friends to see who appears the
                youngest, or simply want a quick and entertaining way to pass
                the time, our app provides accurate and engaging age estimates
                in seconds. Give it a try and uncover a new perspective on how
                you’re seen!
              </p>
          ...
          <div className="max-w-6xl mx-auto flex gap-5 flex-col lg:flex-row items-center justify-between">
            ...
            <div className="w-full lg:w-1/2 space-y-5 lg:pl-12 text-center lg:text-left">
              ...
              <p className="">
                ...
                offers reliable protection. With real-time scanning and
                analysis, it identifies and blocks harmful content before it
                becomes an issue, keeping your platform safe, professional, and
                engaging. Discover how our solution can improve content quality
                and safety for your community today.
              </p>
          ...
          <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center justify-between">
            ...
            <div className="w-full lg:w-1/2 space-y-5 lg:pl-12 text-center lg:text-left">
              ...
              <p className="text-[#ffafcc]">
                Our app combines powerful Content Moderation API with
                intelligent Behavioral Analysis to protect and enhance your
                platform. Detect inappropriate, offensive, or harmful content
                automatically, and get insights into user behavior patterns for
                proactive intervention. Whether you’re running a social media
                site, an educational platform, or a business forum, our solution
                helps you safeguard your community with precision and ease.
              </p>
