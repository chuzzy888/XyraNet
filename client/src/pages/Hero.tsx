    ...
    <div>
        ...
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center justify-between relative">
          ...
          <div className="text-center lg:text-left max-w-lg space-y-5 z-10">
            ...
            <p className="text-lg md:text-xl font-lato text-gray-800">
              ...
              inappropriate content, cyberbullying, and online threats—ensuring
              a safe online experience for all.
            </p>
            <div className="flex justify-center lg:justify-start space-x-4 mt-6">
              {/* <button className="px-6 py-3 bg-green-500 text-white font-semibold font-josefin hidden md:flex items-center rounded-lg shadow-lg hover:bg-green-400 hover:shadow-xl transition duration-300">
                Explore
                <RiArrowRightDownLine className="ml-2 text-2xl" />
              </button> */}
      ...
      {/* <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h2 className="text-5xl font-bold text-gray-800 mb-8 font-lato">
            Trusted by Customers
          </h2>
      ...
      <section className="py-20 px-8 bg-gray-100">
        <div className="max-w-5xl mx-auto text-center mb-12">
          ...
          <p className="text-lg text-gray-700">
            Luxand.cloud provides cloud-based API for different use cases such
            as facial recognition, face detection, face verification, liveness
            detection, and much more. Why choose Luxand.cloud facial recognition
            API?
          </p>
        </div>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col items-center text-center p-6 bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <p className="text-gray-600">
              Starting at just $19/month for 1000 requests, Luxand.cloud offers
