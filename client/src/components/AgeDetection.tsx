      ...
      <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 p-4">
        <div className="bg-white p-8 rounded-lg shadow-md max-w-lg w-full text-center">
          ...
          <div className="flex justify-center gap-4">
            <label className="flex gap-2 items-center cursor-pointer bg-blue-500 text-white px-4 py-2 rounded-md">
            ...
            <button
              ...
              className="flex gap-3 items-center cursor-pointer bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-green-700"
            >
              <IoEnter className="text-2xl mb-1" />
